...
function PrivacyPolicyPage() {
  ...
  return (
    <div className="p-5 mb-5 animated slideInRight fast">
    <HelmetComponent pageTitle={title} ogTitle={title} />
      <h1>Privacy Policy</h1>


      <p>Effective date: June 24, 2019</p>
    
    
      <p>wisdomofdecrowd ("us", "we", or "our") operates the wisdomofdecrowd.com website (the "Service").</p>
      ...
      <p>wisdomofdecrowd uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>If you are located outside Israel and choose to provide information to us, please note that we transfer the data,
      ...
      <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
        that transfer.</p>
      <p>wisdomofdecrowd will take all steps reasonably necessary to ensure that your data is treated securely and in
      ...
      <p>wisdomofdecrowd may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of wisdomofdecrowd</li>
      ...
      <ul>
        <li>By email: garbers8@gmail.com</li>
